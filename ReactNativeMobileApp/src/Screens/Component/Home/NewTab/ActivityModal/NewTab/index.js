...
import styles from '../../../PopularTab/styles';
...
export const ActivityNewTab = (props) => {
  ...
  challenges.map(() => containerRef.push(createRef()));
  ...
  return (
    <View style={{flex: 1, backgroundColor: color.light_background}}>
